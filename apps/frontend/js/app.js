...
const readerhealth = (readerparagraph) => {
    const url='http://reader-service.default.svc.cluster.local/health';
    fetch(url, {
        method: "GET",
        mode: 'cors',
        headers: {
...
async function writeData(e) {
    ...
    const url='http://writer-service.default.svc.cluster.local/write';
    fetch(url, {
        method: "POST",
...
const readData = (paragraph) => {
    const url='http://reader-service.default.svc.cluster.local/reader';
    fetch(url, {
        method: "GET",
        mode: 'cors',
        headers: {
